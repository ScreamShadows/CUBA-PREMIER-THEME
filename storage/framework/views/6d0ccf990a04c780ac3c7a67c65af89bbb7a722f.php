               ...
               <div class="card">
                  <div class="card-body">
                     <div class="email-app-sidebar">
                        <div class="media">
                           <div class="media-size-email"><img class="mr-3 rounded-circle" src="<?php echo e(asset('assets/images/user/user.png')); ?>" alt=""></div>
                              ...
                              <div class="email-top">
                                 <div class="row">
                                    <div class="col-md-6 xl-100 col-sm-12">
                                       <div class="media">
                                          <img class="mr-3 rounded-circle" src="<?php echo e(asset('assets/images/user/user.png')); ?>" alt="">
                                          <div class="media-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\INUSUAL SOFT\laravel\laravel\theme\resources\views/apps/email-application.blade.php ENDPATH**/ ?>