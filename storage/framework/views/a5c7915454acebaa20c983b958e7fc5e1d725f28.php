                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <div class="product-box row">
                                    <div class="product-img col-md-6"><img class="img-fluid" src="<?php echo e(asset('assets/images/ecommerce/01.jpg')); ?>" alt=""></div>
                     ...
                     <div class="modal fade" id="exampleModalCenter1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <div class="product-box row">
                                    <div class="product-img col-md-6"><img class="img-fluid" src="<?php echo e(asset('assets/images/ecommerce/02.jpg')); ?>" alt=""></div>
                                    <div class="product-details col-md-6 text-left">
                                       <h4>Woman T-shirt</h4>
                                       <div class="product-price">$26.00
                                          <del>$350.00    </del>
                     ...
                     <div class="modal fade" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter2" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <div class="product-box row">
                                    <div class="product-img col-md-6"><img class="img-fluid" src="<?php echo e(asset('assets/images/ecommerce/03.jpg')); ?>" alt=""></div>
                                    <div class="product-details col-md-6 text-left">
                                       <h4>Woman T-shirt</h4>
                                       <div class="product-price">$26.00
                                          <del>$350.00    </del>
                     ...
                     <div class="modal fade" id="exampleModalCenter3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter3" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <div class="product-box row">
                                    <div class="product-img col-md-6"><img class="img-fluid" src="<?php echo e(asset('assets/images/ecommerce/04.jpg')); ?>" alt=""></div>
                                    <div class="product-details col-md-6 text-left">
                                       <h4>Woman T-shirt</h4>
                                       <div class="product-price">$26.00
                                          <del>$350.00    </del>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\INUSUAL SOFT\laravel\laravel\theme\resources\views/apps/product.blade.php ENDPATH**/ ?>